...
// Converts a Log In Time string (e.g. "7/29/2026, 8:00:00 PM") — already a plain
// IST wall-clock string generated by the chauffeur's own device — into a
// YYYY-MM-DD calendar date string, for grouping shift blocks by day.
...
// Extracts a Google Drive file ID from a webViewLink and builds a direct-view
// URL usable in an <img src="..."> tag. Falls back to the original link if no
// ID can be parsed.
